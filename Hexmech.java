...
public class Hexmech {
    ...
    public static int h = 0; // height. Distance between centres of two adjacent hexes. Distance between two
     ...
     * Returns: point. A point containing the coordinates of the hex that is clicked
     * in.
     * If the point clicked is not a valid hex (ie. on the borders of the board,
     * (-1,-1) is returned.
     * Function: This only works for hexes in the FLAT orientation. The POINTY
     * orientation would require
